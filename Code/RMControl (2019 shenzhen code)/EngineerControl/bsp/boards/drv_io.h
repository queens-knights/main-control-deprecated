...
#define M0_ON()					HAL_GPIO_WritePin(GPIOF, M0_Pin, GPIO_PIN_SET)
#define M0_OFF()				HAL_GPIO_WritePin(GPIOF, M0_Pin, GPIO_PIN_RESET)
#define M1_ON()					HAL_GPIO_WritePin(GPIOF, M1_Pin, GPIO_PIN_SET)
#define M1_OFF()				HAL_GPIO_WritePin(GPIOF, M1_Pin, GPIO_PIN_RESET)
