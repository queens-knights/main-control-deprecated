...
void closed_loop_handler(void)
{
  ...
  {
    gim.pid.yaw_angle_ref = gim.pid.yaw_angle_ref + rm.yaw_v * GIMBAL_RC_MOVE_RATIO_YAW
  ...
  {
    gim.pid.pit_angle_ref = gim.pid.pit_angle_ref + rm.pit_v * GIMBAL_RC_MOVE_RATIO_PIT
...
void gimbal_param_init(void)
{
  ...
  PID_struct_init(&pid_pit, POSITION_PID, 15000, 0,
                  75, 1, 370); 
  PID_struct_init(&pid_pit_spd, POSITION_PID, 10000, 3000,
                  15, 0.2, 0);
