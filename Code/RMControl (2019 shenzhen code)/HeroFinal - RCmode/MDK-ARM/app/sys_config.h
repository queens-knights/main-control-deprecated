...
/**************************shoot  setting********************************/
/* shoot speed */
#define DEFAULT_FRIC_WHEEL_SPEED 2450 //maximum value is 2500
/* shoot frequence */
...
#define ENCODER_ANGLE_RATIO    ((8191.0f)/360.0f)
//...........................在这改东西了。。。。。。。。。。。。。。
...
#define YAW_MOTO_POSITIVE_DIR   -1.0f //reversed yaw
//...........................在这改东西了。。。。。。。。。。。。。。
...
#define PIT_ANGLE_MIN        -33
#define YAW_ANGLE_MAX        45
#define YAW_ANGLE_MIN        -60

#define LEFT_FRICTION        TIM1->CCR1
#define BACK_S       				 TIM1->CCR4
