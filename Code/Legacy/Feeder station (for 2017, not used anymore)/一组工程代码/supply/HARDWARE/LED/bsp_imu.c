...
#define MPU_delay_ms(x) osdelay_ms(x)
...
/**
	...
	* @param    register address, transfer data
...
/**
	...
	* @brief    read IST8310 register through MPU6500's I2C Master
...
//		delay_ms(2);
////	MPU_delay_ms(2);
//	//enable slave 0 and 1 access delay_ms
//	mpu_write_reg(MPU6500_I2C_MST_delay_ms_CTRL, 0x01 | 0x02);
//		delay_ms(2);
////	MPU_delay_ms(2);
//	//enable slave 1 auto transmit
//	mpu_write_reg(MPU6500_I2C_SLV1_CTRL, 0x80 | 0x01);
//		delay_ms(6);
////	MPU_delay_ms(6); //Wait 6ms (minimum waiting time for 16 times internal average setup)
...
void mpu_get_data(void)
{
	...
	//	if(cali_param.imu_cali_list[CALI_GYRO].calied_done == 0x55){
...
uint8_t mpu_id;
/**
  * @brief     initialize imu mpu6500 and magnetometer ist8310
...
uint8_t mpu_device_init(void)
{
	...
	uint8_t MPU6500_Init_Data[7][2] = {
		...
		{ MPU6500_CONFIG,         0x04 }, // gyro bandwidth 20Hz
